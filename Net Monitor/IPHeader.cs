...
namespace WindowsFormsApplication1
{
    public class IPHeader
    {
        ...
        private byte[] inpRefIPData;               //To have reference of input data
        private uint destAddrOffsetipV4;               // offSetToDestination header


        public IPHeader(ref byte[] byBuffer, int nReceived)
        {

            try
            {
                inpRefIPData = byBuffer;
                destAddrOffsetipV4 = 128;
